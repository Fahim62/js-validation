    ...
    <body>
        ...
        ?>
            ...
            <fieldset>
                ...
                <input type="email" name="email" id="email" placeholder="abcd@gmail.com" pattern=".+@+.+.com" ><span id="emailErr" style="color : blue;"><?php echo $emailErr; ?></span>
                <br><br>
            ...
            <fieldset>
                ...
                <input type="text" id="username" name="username" ><span style="color : green;"><?php echo $userNameErr; ?></span>
                <br><br>
                <label for="password">Password:</label>
                <input type="password" id="password" name="password" pattern=".{4,}" ><span style="color : green;"><?php echo $passwordErr; ?></span>
                <br><br>
